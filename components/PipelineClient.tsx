...
export default function PipelineClient({ leads: initialLeads, trade, avaEnabled }: Props) {
  ...
  return (
    ...
    >
      <style>{`
        .pl-import-btn { transition: background 0.15s ease, border-color 0.15s ease; }
        .pl-import-btn:hover { background: #F3F4F6; border-color: rgba(17,24,39,0.16); }
      `}</style>
      <div
        style={{
          maxWidth: MAX_WIDTH,
