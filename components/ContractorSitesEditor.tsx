...
function WebsiteCard({ site }: { site: ContractorSite }) {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-5">
      ...
      {/* Browser preview */}
      <div className="pointer-events-none overflow-hidden rounded-xl" style={{ maxWidth: "100%" }}>
        <div style={{ transform: "scale(0.75)", transformOrigin: "top left", width: "420px", height: "240px" }}>
          <WebsitePreview
            businessName={site.business_name}
            trade={site.trade}
            city={site.city}
